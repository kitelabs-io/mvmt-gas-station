...
import { cn, linkToWallet } from "@/lib/utils"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Typography } from "@/components/ui/typography"
import CopyButton from "@/components/copy-button"
import NewStationForm from "@/components/new-station-form"
import { findGasStationsBySponsorId } from "@/lib/gas-station"
...
export default async function GasStationPage() {
  ...
  const data = await findGasStationsBySponsorId(sponsorId)
        ...
        return (
          <Card className="max-w-4xl" key={stationId}>
            ...
            <CardContent className="grid grid-cols-5 gap-2">
              ...
              {Object.entries({ predicateType: predicate.kind, predicateValue: predicate.value }).map(
                ([key, value]) => (
